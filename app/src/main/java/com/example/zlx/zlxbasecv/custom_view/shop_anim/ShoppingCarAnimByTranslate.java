 ...
 * Created by Zlx on 2017/2/13.
 */
public class ShoppingCarAnimByTranslate {
    ...
    public interface ShoppingCarOnclickListener {
        void dealMeg();
    }

    private ShoppingCarOnclickListener listener;

    public void setOnShoppingCarOnclickListener(ShoppingCarOnclickListener listener) {
    ...
    public ShoppingCarAnimByTranslate(Activity activity) {
        buyImg = new ImageView(activity);//buyImg是动画的图片
        buyImg.setImageResource(R.mipmap.ic_launcher);// 设置buyImg的图片
