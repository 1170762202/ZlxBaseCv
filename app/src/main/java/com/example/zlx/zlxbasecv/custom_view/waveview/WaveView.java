...
public class WaveView extends View {
    ...
    private int leftOrbitColor = Color.GREEN;
    private int rightOrbitColor = Color.GREEN;
    private int waveViewColor = Color.YELLOW;
    ...
    public void setLeftOrbitColor(int leftOrbitColor) {
        this.leftOrbitColor = leftOrbitColor;
    }

    public void setRightOrbitColor(int rightOrbitColor) {
        this.rightOrbitColor = rightOrbitColor;
    }

    public void setWaveViewColor(int waveViewColor) {
        this.waveViewColor = waveViewColor;
    }
}
