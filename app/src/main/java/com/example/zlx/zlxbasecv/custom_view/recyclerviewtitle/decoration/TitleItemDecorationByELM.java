package com.example.zlx.zlxbasecv.custom_view.recyclerviewtitle.decoration;
...
import com.example.zlx.zlxbasecv.custom_view.recyclerviewtitle.CityBean;
...
public class TitleItemDecorationByELM extends RecyclerView.ItemDecoration {
    ...
    public TitleItemDecorationByELM(Context context, List<CityBean> datas) {
        super();
        mDatas = datas;
        mPaint = new Paint();
        mBounds = new Rect();
