...
public class WaveProgress extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        mDefaultSize = DensityUtil.dip2px(context, 150);
        mRectF = new RectF();
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(DensityUtil.measure(widthMeasureSpec, mDefaultSize),
                DensityUtil.measure(heightMeasureSpec, mDefaultSize));
    }
    ...
    private Point[] getPoint(boolean isR2L, float waveWidth) {
        ...
        return isR2L ? DensityUtil.reverse(points) : points;
    }
