package com.example.zlx.zlxbasecv.custom_view.goodprogressview;
        ...
        for (int i = 0; i < n; i++)
        {
            ...
            switch (attr)
            {
                ...
                case R.styleable.GoodProgressView_endColor:
                    ...
                    break;
                case R.styleable.GoodProgressView_bgColor:
                    // 进度条默认颜色，默认设置为灰色
                    backgroundColor = a.getColor(attr, Color.GRAY);
                    break;
                case R.styleable.GoodProgressView_texColor:
                    // 文字颜色，默认设置为灰色
