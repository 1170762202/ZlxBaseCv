package com.example.zlx.zlxbasecv.custom_view.rolling_view;
...
public class RollingView extends FrameLayout implements View.OnClickListener {
    ...
    public RollingView(Context context, AttributeSet attrs) {
        super(context, attrs);
        // 从xml中获取属性
        TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.RollingView);
        int n = ta.getIndexCount();
        mTextSize = ta.getDimension(R.styleable.RollingView_rv_textSize, mTextSize);
        mTextColor = ta.getColor(R.styleable.RollingView_rv_textColor, mTextColor);
        ta.recycle();
        // 创建默认显示隐藏动画
...
////                View view = LayoutInflater.from(getContext()).inflate(R.layout.rv_item_latest_win_list_fg_home, null);
////                TextView name = (TextView) view.findViewById(R.id.id_tv_name_rv_item_latest_win_list_fg_home);
////                TextView title = (TextView) view.findViewById(R.id.id_tv_title_rv_item_latest_win_list_fg_home);
////                TextView content = (TextView) view.findViewById(R.id.id_tv_content_rv_item_latest_win_list_fg_home);
//                name.setText(array.get(mPageSize * i + n));
//                title.setText(array.get(mPageSize * i + n));
//                content.setText(array.get(mPageSize * i + n));
...
//                container.addView(view);
    ...
    private LinearLayout createContainer() {
        if (mFrameParams == null) {
            mFrameParams = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
    ...
    private TextView createTextView(String text) {
        if (mLinearParams == null) {
            mLinearParams = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
